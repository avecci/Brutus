...
class TestImageAnalyzerUnit(unittest.TestCase):
    ...
    def test_init_success(self):
        ...
        with patch('boto3.client') as mock_boto3_client:
            ...
            self.mock_logger.info.assert_called_with("Successfully initialized Rekognition client")
    ...
    def test_init_failure(self):
        ...
        with patch('boto3.client') as mock_boto3_client:
            ...
            with self.assertRaises(Exception):
                BrutusSees()
            self.mock_logger.error.assert_called_with("Failed to initialize client", exc_info=True)
    ...
    def test_compare_faces_success(self):
        ...
        self.analyzer.rekognition_client.compare_faces.return_value = mock_compare_response

        # Mock file system operations and image source
        with patch('os.listdir') as mock_listdir, \
             patch.object(self.analyzer, '_source_image', return_value=b'image_bytes'):
    ...
    def test_detect_labels_error(self):
        ...
        self.analyzer.rekognition_client.detect_labels.side_effect = Exception("AWS Error")
